...
export function mountGrade(app, { verifyToken, ledgerDb, loadAnswerKey, lessonSchedule, db, config = PHASE3_CONFIG, worksheetBlankCounts = null, blooketLessons = null }) {
  ...
  app.get('/grade', async (req, res) => {
    ...
    const { units, quarters, completion, lessons } = computeGrade(
      ...
      answerKey,
      config,
      { lessonSchedule, section, worksheetBlankCounts, blooketLessons }
    );
