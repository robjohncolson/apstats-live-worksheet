...
This project is indexed by GitNexus as **apstats-live-worksheet** (18646 symbols, 35155 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
