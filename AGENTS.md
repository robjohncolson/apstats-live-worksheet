...
This project is indexed by GitNexus as **apstats-live-worksheet** (19809 symbols, 38653 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
