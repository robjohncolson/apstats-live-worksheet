...
\daybanner{AP Statistics \textperiodcentered\ Unit 3 \textperiodcentered\ Topic 3.8 \textperiodcentered\ B: 2026-12-15 \textperiodcentered\ E: 2026-12-18 \textperiodcentered\ TEACHER KEY}{Which Error Can the District Afford?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item At minute 5, read the rules box and start (a). At minute 33, ask students to name the decision and true state for each probability.
  \item Collect at the door. Score part (c) only, E/P/I.
\end{itemize}
}{%
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Choose a plan and name the prioritized error.
  \item Read the rules box, work (a)--(c), revise the first take, and turn in the sheet.
\end{itemize}
}{%
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
