...
\ladderheading{AP Statistics \textperiodcentered\ Topic 4.5 (CED 2.6) \textperiodcentered\ B: 2026-10-26 \textperiodcentered\ E: 2026-11-13}{Which Way Does the Condition Point?}
...
\begin{sentenceframebox}\raggedright\textbf{Frame:} The $90\%$ describes $P(\blank[1.2in]\mid\blank[1.2in])$, but the claim asks for $P(\blank[1.2in]\mid\blank[1.2in])$.\end{sentenceframebox}

\begin{sentenceframebox}\raggedright\textbf{Frame:} Among the \blank[0.7in] positive results, \blank[0.6in] are true positives and \blank[0.6in] are false positives, so \blank[2.1in].\end{sentenceframebox}
