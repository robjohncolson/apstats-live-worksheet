...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topics 1.7--1.8 (CED 1.7--1.8) \textperiodcentered\ E: 2026-09-23 \textperiodcentered\ TEACHER KEY}{Typical Hours, Exceptional Week}
...
\frameworkphaseheader{First take $\rightarrow$ rules + (a)--(c) $\rightarrow$ turn in}{1 $\rightarrow$ 3}{43.5}{%
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Read the competing reports without endorsing either. Start the first take at the bell.
  \item Read the rules box; work (a) then (b) in teaching order.
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Work (a)--(c) in order from the rules box, then turn in one sheet.
\end{itemize}
}{%
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
...
One claim I would revise after reading the rules box: \hrulefill
\end{summaryexitbox}
