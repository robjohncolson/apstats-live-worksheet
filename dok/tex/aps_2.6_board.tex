...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  ...
  \item[\dokbadge{2}~(b)] Predict flight duration at 1.8 and 3.5 kg. How much does the 3.5-kg prediction exceed the required 12 minutes?
  \item[\dokbadge{3}~(c)] Would you approve this mission now? Compare the support for the two predictions using the tested payload range and the extra time from (b). Explain what evidence you would want before relying on the 3.5-kg prediction. Write 3--4 sentences.
\end{description}
