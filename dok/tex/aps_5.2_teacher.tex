...
\daybanner{AP Statistics \textperiodcentered\ Unit 2 \textperiodcentered\ Topic 2.11 \textperiodcentered\ B: 2026-11-16 \textperiodcentered\ E: 2026-11-18 \textperiodcentered\ TEACHER KEY}{Comparing a Score of 92}
...
\textbf{DOK rationale:} Part (c) combines two percentile comparisons with the effect of spread to judge competing same-score claims and explain the relative standing supported by the models.\par
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the rules box to compare the spreads and calculate both z-scores and percentiles.
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{judgment-1} (required) --- Supports the data coach using percentiles about 90.9 at A and 78.8 at B.
  \item \textbf{judgment-2} (required) --- Explains that the same 12-point gap is different numbers of standard deviations because the spreads differ.
  \item \textbf{judgment-3} (required) --- Concludes that 92 has higher relative standing at A and explains why the shared mean is insufficient.
\end{itemize}
...
Would a 92 stand out equally at both schools? Give one reason from the picture.\par
