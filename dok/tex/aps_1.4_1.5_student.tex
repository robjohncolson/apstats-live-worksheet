...
\end{center}
\begin{firsttakebox}{FIRST TAKE --- before the videos (5 min)}
...
\newpage
\textbf{Finish after both topics' videos:}\par\smallskip
...
One claim I would revise after both videos: \hrulefill\par
\workspace{0.4in}
\end{summaryexitbox}
