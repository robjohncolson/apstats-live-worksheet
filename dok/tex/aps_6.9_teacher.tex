...
\daybanner{AP Statistics \textperiodcentered\ Unit 3 \textperiodcentered\ Topic 3.11 \textperiodcentered\ B: 2026-12-14 \textperiodcentered\ E: 2027-01-25 \textperiodcentered\ TEACHER KEY}{A Positive Effect Is Not Every Positive Claim}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{selects-bounded-claim} (required) --- Selects Iris and uses the interval above zero
  \item \textbf{evaluates-practical-threshold} (required) --- Uses $0.10$ inside and lower endpoint $0.018$
  \item \textbf{interprets-confidence-level} (required) --- Treats 95 percent as long-run method performance
  \item \textbf{bounds-causal-scope} (required) --- Uses random assignment for a causal conclusion
  \item \textbf{bounds-population-scope} (required) --- Uses volunteer recruitment to limit generalization
\end{itemize}

{\small\renewcommand{\arraystretch}{1.25}
\noindent\begin{tabular}{|p{0.5in}|p{5.9in}|}
\hline
\textbf{E} & Chooses Iris, uses 0 and 0.10, interprets confidence, and separates causal from population scope. \\ \hline
\textbf{P} & Finds a positive but not guaranteed 10-point effect while weakening confidence or scope. \\ \hline
\textbf{I} & Guarantees 10 points, assigns 95 percent to the parameter, or generalizes volunteers district-wide. \\ \hline
\end{tabular}}
...
Whose claim is supported? Cite one endpoint or design feature.\par
