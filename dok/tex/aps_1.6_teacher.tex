...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topic 1.6 \textperiodcentered\ B: 2026-09-17 \textperiodcentered\ E: 2026-09-18 \textperiodcentered\ TEACHER KEY}{Describing a Distribution}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item At minute 5, read the rules box aloud once; students start (a). Collect nothing yet.
...
\answer{Not graded. Expect a near-even split; the point is that they committed before the discussion.}
\end{firsttakebox}
