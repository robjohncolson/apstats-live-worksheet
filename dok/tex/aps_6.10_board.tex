...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  ...
  \item[\dokbadge{3}~(c)] In 3--4 sentences, choose and state the hypotheses. Use the original word change and when the direction was chosen. Explain how Omar's choice after seeing the result changes the question and could overstate the evidence.
\end{description}
