...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topic 1.2 \textperiodcentered\ B: 2026-09-10 \textperiodcentered\ E: 2026-09-11 \textperiodcentered\ TEACHER KEY}{Getting to School: Survey Data}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item At minute 5, read the rules box; have students start (a).
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the definitions in the rules box to identify individuals and classify the variables.
