...
\daybanner{AP Statistics \textperiodcentered\ Unit 5 \textperiodcentered\ Topic 5.2 \textperiodcentered\ B: 2027-03-04 \textperiodcentered\ E: 2027-03-05 \textperiodcentered\ TEACHER KEY}{What Does This Correlation Support?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Commit to a proposal, then use the rules box to compare the correlations and the plot.
