...
\daybanner{AP Statistics \textperiodcentered\ Unit 5 \textperiodcentered\ Topic 5.3 \textperiodcentered\ B: 2027-03-05 \textperiodcentered\ E: 2027-03-08 \textperiodcentered\ TEACHER KEY}{Two Payloads, One Regression Line}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Read the rules box, work (a)--(c), revise the first take, and turn in.
\end{itemize}
}{%
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
