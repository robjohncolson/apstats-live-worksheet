...
\daybanner{AP Statistics \textperiodcentered\ Unit 3 \textperiodcentered\ Topic 3.3 \textperiodcentered\ B: 2026-12-04 \textperiodcentered\ E: 2026-12-07 \textperiodcentered\ TEACHER KEY}{Two Library Survey Plans}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item At minute 5, read the rules box and start (a). At minute 33, ask what the collection method lets them conclude.
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{judgment-1} (required) --- Chooses A using its SRS and a valid numerical condition.
  \item \textbf{judgment-2} (required) --- Compares B width 0.0661 with A width 0.1368.
  \item \textbf{judgment-3} (required) --- Explains that B self-selection can bias its estimate and its narrow formula margin does not justify population confidence.
\end{itemize}
