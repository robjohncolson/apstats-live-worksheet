...
\daybanner{AP Statistics \textperiodcentered\ Unit 2 \textperiodcentered\ Topic 2.6 \textperiodcentered\ B: 2026-10-29 \textperiodcentered\ E: 2026-10-30 \textperiodcentered\ TEACHER KEY}{Which Way Does the Condition Point?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the rules box to identify the given group before calculating each conditional percentage.
