...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  ...
  \item[\dokbadge{3}~(c)] In 3--4 sentences, choose a rule for getting within 0.06 of $p$ and use the table to defend it. Explain what Lena and Omar each overlook about bias and variability.
\end{description}
