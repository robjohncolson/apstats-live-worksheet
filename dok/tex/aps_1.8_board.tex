...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  \item[\dokbadge{1}~(a)] Read the median and the two quartiles from the boxplot.
  \item[\dokbadge{2}~(b)] In two sentences, describe the dotplot's groups and empty interval. Count how many students took more than 30 minutes.
  \item[\dokbadge{3}~(c)] Whose interpretation is better supported? Use a dotplot feature to explain what the boxplot hides. Choose a display for deciding whether more than half the students need over 30 minutes, and defend your choice.
\end{description}
