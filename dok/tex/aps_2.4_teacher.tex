...
\daybanner{AP Statistics \textperiodcentered\ Unit 5 \textperiodcentered\ Topic 5.1 \textperiodcentered\ B: 2027-03-02 \textperiodcentered\ E: 2027-03-05 \textperiodcentered\ TEACHER KEY}{One Plot, Two Reporting Strategies}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Commit to a reporting strategy, then use the rules box to work (a) and (b).
