...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  ...
  \item[\dokbadge{3}~(c)] In 3--4 sentences, decide which threshold claim the interval supports and whose reasoning is better. Compare the lower endpoint with 0.60 and 0.65. Explain why a plausible 0.65 is different from establishing at least 0.65.
\end{description}

\vfill
\noindent\begin{minipage}{0.84\linewidth}
\textbf{Optional review:} \href{https://robjohncolson.github.io/apstats-live-worksheet/u6_lesson3_live.html}{follow-along} (scan the code)\par
