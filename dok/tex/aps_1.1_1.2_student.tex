...
\begin{itemize}[leftmargin=1.6em,itemsep=0pt,topsep=1pt,parsep=0pt]
  \item[{\setlength{\fboxsep}{0pt}\fbox{\rule{0pt}{0.65em}\hspace{0.65em}}}] State what each percentage is a percent OF, and compare the correct one with the 25\% limit.
  \item[{\setlength{\fboxsep}{0pt}\fbox{\rule{0pt}{0.65em}\hspace{0.65em}}}] Recommend A, B, or a revised report, using the rule for which records belong.
  \item[{\setlength{\fboxsep}{0pt}\fbox{\rule{0pt}{0.65em}\hspace{0.65em}}}] Explain what varying thickness means and whether variation alone justifies deleting a record.
  \item[{\setlength{\fboxsep}{0pt}\fbox{\rule{0pt}{0.65em}\hspace{0.65em}}}] Say what stage codes and ZIP codes each stand for, and why averaging them answers nothing.
\end{itemize}}
\workspace{1.5in}
