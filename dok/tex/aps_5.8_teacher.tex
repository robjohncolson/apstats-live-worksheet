...
\daybanner{AP Statistics \textperiodcentered\ Topic 5.8 (CED 4.6) \textperiodcentered\ B: 2027-01-22 \textperiodcentered\ E: 2027-03-10 \textperiodcentered\ TEACHER KEY}{Two Samples, One Difference}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Begin the Topic 5.8 video follow-along at minute 5.
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{uses-north-normal-route} (required) --- Uses North population normality despite $n_N=12$
  \item \textbf{uses-south-clt-route} (required) --- Uses South $n_S=48$ with the CLT
  \item \textbf{coordinates-difference-model} (required) --- Uses both component models and independence for $0.0273$
  \item \textbf{adjudicates-both-accounts} (required) --- Diagnoses both incomplete rules
  \item \textbf{traces-counterfactual} (required) --- Uses $n_S=8$ to expose the combined-size shortcut
\end{itemize}

{\small\renewcommand{\arraystretch}{1.25}
\noindent\begin{tabular}{|p{0.5in}|p{5.9in}|}
\hline
\textbf{E} & Justifies both components by distinct routes, coordinates independence, diagnoses both accounts, and explains the $n_S=8$ consequence. \\ \hline
\textbf{P} & Reaches the warranted verdict but omits a route, independence, or the counterfactual consequence. \\ \hline
\textbf{I} & Requires both populations normal or uses one/combined sample size to justify both means. \\ \hline
\end{tabular}}
...
Identify one argument you would retain and one that needs more evidence. Cite a population shape or sample size.\par
