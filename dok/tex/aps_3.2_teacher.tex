...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topic 1.10 \textperiodcentered\ B: 2026-09-28 \textperiodcentered\ E: 2026-09-28 \textperiodcentered\ TEACHER KEY}{What Can Each Study Claim?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the rules box to classify the plans and explain the outside factor in (b).
