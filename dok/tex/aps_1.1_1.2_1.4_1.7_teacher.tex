...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topics 1.1--1.7 (CED 1.1--1.7) \textperiodcentered\ TEACHER KEY}{Screen Time, Two Deletions}
...
\textbf{Word bank:} \textbf{median} \ensuremath{\;\cdot\;} \textbf{it resists unusual values} \ensuremath{\;\cdot\;} mode \ensuremath{\;\cdot\;} \textbf{mean} \ensuremath{\;\cdot\;} it follows unusual values \ensuremath{\;\cdot\;} omit the deletion details \ensuremath{\;\cdot\;} \textbf{disclose and justify the deletions}
