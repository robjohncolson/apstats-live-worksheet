...
\daybanner{AP Statistics \textperiodcentered\ Unit 3 \textperiodcentered\ Topic 3.6 \textperiodcentered\ TEACHER KEY}{Which Tail, and Probability of What?}
...
Printed normal table: $P(Z\leq-1.7056)=0.044041$. For a symmetric normal curve, the two-sided area is twice the smaller tail area.
\end{callout}
