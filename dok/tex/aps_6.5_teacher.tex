...
\daybanner{AP Statistics \textperiodcentered\ Unit 3 \textperiodcentered\ Topic 3.6 \textperiodcentered\ B: 2026-12-10 \textperiodcentered\ E: 2026-12-14 \textperiodcentered\ TEACHER KEY}{Which Tail, and Probability of What?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the rules box to choose the tail, calculate the statistic, and compare the two p-values.
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{judgment-1} (required) --- Chooses Priya's left-tail probability near 0.044 and ties it to the fallen research question.
  \item \textbf{judgment-2} (required) --- Interprets the probability as sample proportions at or below 0.49 in random samples of 200, assuming p=0.55.
  \item \textbf{judgment-3} (required) --- Explains that Noah's doubled probability answers a two-sided question and does not measure the chance a hypothesis is true.
\end{itemize}
...
Does fallen mean only a drop in support, or a change in either direction? Give one reason from the study.\par
