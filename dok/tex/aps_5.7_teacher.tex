...
\daybanner{AP Statistics \textperiodcentered\ Unit 4 \textperiodcentered\ Topic 4.1 \textperiodcentered\ B: 2027-01-25 \textperiodcentered\ E: 2027-01-27 \textperiodcentered\ TEACHER KEY}{Two Production Lines, Two Sampling Plans}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the rules box to check each model before calculating its normal tail probability.
