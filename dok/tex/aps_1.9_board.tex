...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  \item[\dokbadge{1}~(a)] Read the median for each class.
  \item[\dokbadge{2}~(b)] In two or three sentences, compare the quiz scores' center, spread, apparent shape, and unusual features. Use points and comparative words.
