...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topic 1.11 \textperiodcentered\ B: 2026-09-29 \textperiodcentered\ E: 2026-09-30 \textperiodcentered\ TEACHER KEY}{Three Ways to Sample Students}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the printed definitions to name the methods and explain which one is an SRS.
