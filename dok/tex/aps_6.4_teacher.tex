...
\daybanner{AP Statistics \textperiodcentered\ Topic 6.4 (CED 3.5) \textperiodcentered\ B: 2026-12-03 \textperiodcentered\ E: 2027-01-08 \textperiodcentered\ TEACHER KEY}{Which Test Answers the Question Asked?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{selects-directional-setup} (required) --- Selects Maya and ties $>$ to the pre-stated increase
  \item \textbf{separates-parameter-statistic} (required) --- Keeps $p_0=0.40$ and $\hat p=84/180$ in distinct roles
  \item \textbf{verifies-all-conditions} (required) --- Verifies SRS, $180\le240$, and expected counts 72 and 108
  \item \textbf{explains-two-sided-consequence} (required) --- Explains that $\neq$ would count a decrease as evidence
  \item \textbf{explains-null-counts} (required) --- Explains that large counts models $H_0$
\end{itemize}

{\small\renewcommand{\arraystretch}{1.25}
\noindent\begin{tabular}{|p{0.5in}|p{5.9in}|}
\hline
\textbf{E} & Chooses Maya, links direction to the question, separates parameter from statistic, verifies conditions, and critiques Theo. \\ \hline
\textbf{P} & Chooses Maya with correct setup but incompletely explains a rejected choice. \\ \hline
\textbf{I} & Chooses two-sided because samples vary, puts $\hat p$ in a hypothesis, or uses observed counts as the test condition. \\ \hline
\end{tabular}}
...
Which setup better answers whether ridership increased? Choose Maya or Theo and cite one detail from the question or sample.\par
