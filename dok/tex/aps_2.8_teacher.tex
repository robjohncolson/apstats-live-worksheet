...
\daybanner{AP Statistics \textperiodcentered\ Unit 5 \textperiodcentered\ Topic 5.5 \textperiodcentered\ B: 2027-03-09 \textperiodcentered\ E: 2027-03-10 \textperiodcentered\ TEACHER KEY}{Which Regression Line Fits?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Make a first claim, then use the printed formulas to work (a) and (b).
