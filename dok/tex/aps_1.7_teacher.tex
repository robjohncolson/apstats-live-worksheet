...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topic 1.7 \textperiodcentered\ B: 2026-09-21 \textperiodcentered\ E: 2026-09-23 \textperiodcentered\ TEACHER KEY}{Which Summary Tells the Story?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Show both claims without endorsement. At minute 5, read the rules box.
  \item At minute 33, press calculation versus choice; collect and score part (c), E/P/I.
\end{itemize}
}{%
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Choose first; read the rules box; work (a)--(c); complete the exit; turn in.
\end{itemize}
}{%
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
