...
\daybanner{AP Statistics \textperiodcentered\ Unit 2 \textperiodcentered\ Topic 2.11 \textperiodcentered\ B: 2026-11-12 \textperiodcentered\ E: 2026-11-16 \textperiodcentered\ TEACHER KEY}{Check the Model}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item Commit to using or rejecting the model before any discussion.
  \item Use the printed rules to check both model calculations in (b).
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{model-versus-data} (required) --- Distinguishes correct model arithmetic from whether it fits these students
  \item \textbf{shape-and-tail} (required) --- Uses the long right tail and observed 4/60 about 6.7 percent versus predicted 0.62 percent
  \item \textbf{consequence} (required) --- Explains that the model understates long app times and needs checking against the data
\end{itemize}
...
Do the times look balanced around 40 minutes, or does one side stretch farther? Point to the bars.\par
