...
\daybanner{AP Statistics \textperiodcentered\ Topic 3.6 (CED 1.13) \textperiodcentered\ B: 2026-10-05 \textperiodcentered\ E: 2026-10-16 \textperiodcentered\ TEACHER KEY}{When Blocking Earns Its Keep}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item \textbf{explains-chance-imbalance} (required) --- Explains how treatment imbalance across sunny and shaded houses could mask or reverse an effect in Design A
  \item \textbf{bounds-inference} (required) --- States a conditional causal conclusion from random assignment and statistical significance, while limiting generalization beyond the studied conditions
\end{itemize}
