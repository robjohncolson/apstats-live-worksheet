...
\daybanner{AP Statistics \textperiodcentered\ Unit 2 \textperiodcentered\ Topic 2.12 \textperiodcentered\ B: 2026-11-17 \textperiodcentered\ E: 2026-11-20 \textperiodcentered\ TEACHER KEY}{One Sample Far From the Others}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the rules box to identify the parameter and statistic, then describe the sample means.
