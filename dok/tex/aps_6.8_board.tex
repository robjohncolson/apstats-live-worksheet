...
\daybanner{Unit 3 \textperiodcentered\ Topic 3.10 \textperiodcentered\ TODAY'S PROBLEM}{Two Ways to Build an Interval}
...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  ...
  \item[\dokbadge{3}~(c)] In 3--4 sentences, choose a method using the independent samples and the variance formula. Explain why subtracting separate 95\% intervals does not establish a 95\% interval for the difference. Use zero's location to explain how the method changes the conclusion.
\end{description}
