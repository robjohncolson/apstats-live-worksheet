...
\daybanner{AP Statistics \textperiodcentered\ Unit 2 \textperiodcentered\ Topic 2.7 \textperiodcentered\ B: 2026-11-02 \textperiodcentered\ E: 2026-11-04 \textperiodcentered\ TEACHER KEY}{Overlap Does Not Decide Independence}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  ...
  \item Use the rules box and table to calculate the probabilities in (a) and (b).
