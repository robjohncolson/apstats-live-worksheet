...
\begin{description}[leftmargin=1.15in, labelwidth=1in, itemsep=2pt, topsep=2pt]
  ...
  \item[\dokbadge{3}~(c)] In 3--4 sentences, choose a setup using the director's word increased. Explain why the count check uses 72 and 108 rather than 84 and 96. State what different question Theo's alternative would answer.
\end{description}
