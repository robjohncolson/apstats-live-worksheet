...
\daybanner{AP Statistics \textperiodcentered\ Unit 1 \textperiodcentered\ Topic 1.7 \textperiodcentered\ TEACHER KEY}{Which Summary Tells the Story?}
...
\begin{itemize}[leftmargin=1.5em,itemsep=2pt,topsep=2pt]
  \item \textbf{quartile-method} (required) --- Identifies Kai's IQR 8 and explains Rosa's inclusion of the overall median
  \item \textbf{corrected-pair} (required) --- Chooses median 8 and IQR 8 hours
  \item \textbf{feature-and-resistance} (required) --- Links isolated 30 or right skew to why mean/SD are more affected than the chosen pair
\end{itemize}
...
\answer{Exclude the overall median: $Q_1=4$, $Q_3=12$, IQR $=8$, and the upper fence is $12+1.5(8)=24$ hours. The 30-hour value exceeds it. Kai's supplied mean 8.4 and sample SD about 7.5 are correct; recalculating them is not required.}
...
\answer{Kai's IQR of 8 follows the printed rule. Rosa included the overall median in each half, giving quartiles 4.5 and 11 and IQR 6.5. Report median 8 and corrected IQR 8 hours: the isolated 30-hour value pulls the nonresistant mean and SD, especially the spread. The resistant pair describes the middle of the distribution without letting that one student's hours dominate.}
